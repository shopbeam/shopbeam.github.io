...
Enterprise.TopCart = {
    initialize: function (container) {
        return; // disable TopCart
        this.container = $(container);
        this.element = this.container.up(0);
        this.elementHeader = this.container.previous(0);
        this.intervalDuration = 1000; // 4000
        this.interval = null;
        this.onElementMouseOut = this.handleMouseOut.bindAsEventListener(this);
        this.onElementMouseOver = this.handleMouseOver.bindAsEventListener(this);
        this.onElementMouseClick = this.handleMouseClick.bindAsEventListener(this);
        this.container.observe('mouseout', this.onElementMouseOut);
        this.container.up().observe('mouseout', this.onElementMouseOut);
        this.element.observe('mouseover', this.onElementMouseOver);
        this.container.down(1).observe('mouseover', this.onElementMouseOver);
        this.elementHeader.observe('click', this.onElementMouseClick);
    },
    handleMouseOut: function (evt) {
		if($(this.elementHeader).hasClassName('expanded') && this.interval === null) {
...
Enterprise.Bundle = {
     ...
     reloadPrice: function () {
         var result = Enterprise.Bundle.oldReloadPrice.bind(this)(),
            priceContainer = $('bundle-product-wrapper').down('.price-box .price-as-configured');
         if (priceContainer) {
            var duplicateContainer = $('bundle-product-wrapper').down('.duplicate-price-box .price-as-configured');
...
a.src=document.location.protocol+"//dnn506yrbagrg.cloudfront.net/pages/scripts/0011/5055.js?"+Math.floor(new Date().getTime()/3600000);
