...
//			return false;
		...
		init : function(){
			...
			$("[hTrack='fblikeTop'],[hTrack='fblikeBot']").click(function(){eventTracking("event1");});
			...
			$("[hvtnode='pinbutton'] a").click(function(){eventTracking("event26");});
			$("[hTrack='inshare']").click(function(){eventTracking("event74");});
			$("[hTrack='twitterBot']").click(function(){eventTracking("event85");});
					...
					if (hsocial_tool._vars.PINCounter === 0) {
						$.ajax({
							 ...
							 complete: function() {
								...
								{
									$("#pinContent .tooltip_pn_follow a").attr("target","_blank");
									$("#pinContent .tooltip_pn_follow a").append("<b></b><i></i>");
								}
								else
								{
...
$(document).ready(function(){
	...
	$(window).load(hsocial_tool.twitter.getNumber)
