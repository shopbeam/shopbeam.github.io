 ...
 * History: 1.0.0 04.12.2010 Added version number.
            ...
            1.0.7 08.02.2012 Modifications for Teen Vogue. Got rid of the document.write.
 */
...
CN.stats.omniture = (function() {
    ...
    var s_account = "conde-teenvogue",
        server = "stats2.teenvogue.com",
        secureServer = "sstats.teenvogue.com",
        internalFilters = "javascript:,teenvogue.com",
        httpStatus = 200;
    ...
    function setPageName() {
        ...
        if (directories[0] === "") {
            ...
            tempPageName = tempPageName.split('?')[0].replace(/\/$/,'');
        }
    ...
    var sProps = {
        ...
        /*
         * prop74: Slideshow Content Type
         * where: Slideshow pages.
         * what: Set to content type of the page.
         * @memberOf CN.stats.omniture
         * @private
         */
        prop74: function () {
            return this.prop74.data || '';
        },
        ...
        prop48 : function () {
         ...
         /*
         * prop50:
         * where: blog entry pages.
         * what: content category .Online || Magazine
         * @memberOf    CN.stats.omniture
         * @private
         */
         prop50 : function () {
                return this.prop50.data || '';
         },
    ...
    *    */
    ...
    return {
        ...
        /**
         * @name CN.stats.omniture#setSlideshowContentType
         * @function
         * @description Sets the Slideshow content type Default: '' (prop74)
         * @param {string} id the content type
         */
        setSlideshowContentType: function(type) {
        ...
        setProductStatus: function(productstatus) {
           if(productstatus != 'unset'){
              if(productstatus=="Purchasable"){
                  eVars.eVar43.data = "Purchasable";
                   s.products += ';event37=1;eVar43=' + eVars.eVar43.data;
               }
                else{
                   eVars.eVar43.data = "Not Purchasable";
                  s.products += ';event38=1;eVar43=' + eVars.eVar43.data;
               }
           } else {
                eVars.eVar43.data = null;
           }
        ...
        setProductName : function(productName) {
                if(productName == "No Product"){
                     s.products = null;
                     eVars.eVar53.data = null;
                }
               else if(productName != 'unset'){
                         eVars.eVar53.data = productName;
                         if(typeof s.products == "undefined" || s.products == ""){
                              s.products = ';'+ productName + ';;';
                          }
                          else if(CN.page.config.multiProducts == true && productName != null){
                             s.products += ';'+ productName + ';;';
                         }
                 }
                 else {
        ...
        setProductAvailabilityStatus : function(productStatus) {
            if(productStatus != 'unset'){
                ...
                s.products += '|eVar54=' + productStatus;
           }else{
                eVars.eVar54.data = null;
          }
        ...
        /**
         * @name CN.stats.omniture#setContentCategory
         * @function
         * @description Set content category variable. (prop50)
         * @param {string}  value content category for Blog entry content.
         */
        setContentCategory : function (mtContentCategory) {
            sProps.prop50.data = mtContentCategory;
            return this;
        },
        ...
        */
        ...
        doPlugins: function(s) {
            ...
            /* Detects if referrer is a recognized social network  //new addition - Aug 2011*/
       ...
       /**
        ...
        setCartTracking : function(args) {
            if (arguments.length > 0) {
                if(arguments[0] != "") {
                    s.products = arguments[0] + ';' +  arguments[1];
                }
            }
            if (arguments.length > 1) {
               CN.stats.omniture.trackAjaxPage(arguments[2],arguments[3]);
            }
        }
    }
