...
function EventList(divId) {
    ...
    this.writeTags = function (tagUrl, tagFunc) {
        ...
        fullUrl = this.baseUrl + tagUrl + "?" + this.eventList[0].getQueryString("e0_");
        for (i = 1; i < this.eventList.length; ++i) {
            eventQueryString = this.eventList[i].getQueryString("e" + i + "_");
            tmpFullUrl = fullUrl + eventQueryString;
