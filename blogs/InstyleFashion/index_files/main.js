    ...
    var PartnerRecirc = function() {
        ...
        var getStarted = function() {
            ...
            if (document.getElementById(arr[nextFeed].id)) {
                ...
                arr[nextFeed].display = (arr[nextFeed].display) ? arr[nextFeed].display : 5;
...
//	initialize Partner Recirc feeds on photo channel page
    var initializeGlobalRecirc = function() {
        ...
        var recircArray = {
             'recircs' : /*this is the original code with all the recircs [ 
                {
                ...
                },/* DDM put back in when template changes have been made to style correctly 10.26.2011-THIS IS COMMENTED OUT{
                    'id'		: 'makeupbbbrecirc',	
                    'display'	: 2,
                    'feed' 		: [
                        {
			...
			[ 
                {
                    ...
                    'feed' 		: [ 
                        {
							'name'  	: 'msnbc',
                            'json' 		: 'http://www.instyle.com/instyle/static/json/msnbctoday/feed.js',
	 ...
	 findpinit : function() {
        ...
        appendAdScript : function(config) { // id required. w AND h OR multi required.
            ...
            try {
                ...
                alert (id + " " + document.getElementById(id)  + err);
            }
...
//hot fix for hp vid tout 1/6/13

$( document ).ready(function() {
$('#vidpreview h2').html('Cover Story Peek: In The Magazine');
});

// Set ads to async mode if in galleries
if ( ( location.href.indexOf("/photos") > 1 ) || ( location.href.indexOf("/gallery") > 1 ) || ( location.href.indexOf("/look-of-the-day") > 1 ) || ( location.href.indexOf("/instyle/package") > 1 ) ) {
...
if ( ( location.href.indexOf("/photos") == -1 ) && ( location.href.indexOf("/gallery") == -1 ) && ( location.href.indexOf("/look-of-the-day") == -1 ) ) {
docCookies.setItem('lastePageViewed', location.href, 0, '/', '.instyle.com');
}

//add active class to navigation if on channel page
$( document ).ready(function() {
	if (s_time.pageName.indexOf("fashion") > 1 ) {
		$('.nav-fashion a').addClass('active');
	} else if (s_time.pageName.indexOf("celebrity") > 1 ) {
		$('.nav-celebrity a').addClass('active');
	} else if (s_time.pageName.indexOf("hair") > 1 ) {
		$('.nav-hair a').addClass('active');
	} else if (s_time.pageName.indexOf("makeup") > 1 ) {
		$('.nav-makeup a').addClass('active');
	}
});	


//Add native ad call to DIO jcarousels 
//If there are more than 4 items, take the 3rd spot 
// Increment each gallery count # accordingly

$( document ).ready(function() {


$(".module-related-galleries .jcarousel li:nth-child(4)").addClass('fullyvisible');
	//amount of items in the carousel
	var relatedGallerylength = $('.page-digital-issue .module-related-galleries .jcarousel ul li').length;
		relatedGallerylength = relatedGallerylength/2;
	
		//if jcarousel has more than 4 items
		if (  relatedGallerylength > 4 ) {
		
			//insert native ad iframe call in the 3rd spot
			$(".module-related-galleries .jcarousel li:nth-child(2)").after('<iframe class="native_dio_ad" src="http://www.instyle.com/instyle/static/v4/h/ads/dio_native.html"  style="display:none;" allowtransparency="true"  width="220" height="358" frameborder="0" scrolling="no"></iframe>');
		}	
	
		//increase gallery count for each jcarousel once iframe has loaded
		 $('.module-related-galleries .jcarousel iframe').load(function(){
			if ($('.module-related-galleries .jcarousel iframe').hasClass('active')) {
...
function show_dio_nav_ad() {
	$('.native_dio_ad').addClass('active');
	$('.native_dio_ad').show();
...
var galleryTitle = '';
	...
	function fireOmnitureHero(){
		
		carousel_index = $('.module-feature-hero .jcarousel .active').attr('data-carousel-index');
		galleryTitle = $('.module-feature-hero .jcarousel .active .article-title').text();
			console.log(carousel_index);
			console.log(galleryTitle);
			
			s_time.pageName = 'instyle|home|hero ' + carousel_index + '_gallery:' + galleryTitle;
		var s_code=s_time.t();if(s_code)document.write(s_code);
	}
	
	$('body').on('click', '.module-feature-hero .jcarousel ul li', fireOmnitureHero);
	$('body').on('click', '.module-feature-hero .carousel-controls a', fireOmnitureHero);
	
	function fireOmnitureLOTD(){
		...
		carousel_index = $('.module-lotd .jcarousel li:hover').attr('data-carousel-index');
		galleryTitle = $('.module-lotd .jcarousel li:hover .blurb h2').text();
			console.log(carousel_index);
			console.log(galleryTitle);
			
			s_time.pageName = 'instyle|home|LOTD ' + carousel_index + '_gallery:' + today +'|'+ galleryTitle;
		var s_code=s_time.t();if(s_code)document.write(s_code);
	}
	
	$('body').on('click', '.module-lotd .jcarousel ul li', fireOmnitureLOTD);
	$('body').on('click', '.module-lotd .jcarousel-pagination', fireOmnitureLOTD);
// 	$('body').on('click', '.module-lotd .jcarousel-control-prev', fireOmnitureLOTD);
// 	$('body').on('click', '.module-lotd .jcarousel-control-next', fireOmnitureLOTD);
	
	//OMNITURE USER ACTIONS TRACKING
	...
	$('body').on('click', '.fave-this-btn', handleClick);
	$('body').on('click', '.unfave-this-btn', handleClick);
		
	var omni_share_headline = '';
	$( document ).ready(function() {
	  $(".share-popup").click(function() {
		omni_share_headline = $(this).data("share-headline");
		 console.log(omni_share_headline);
		});
	});		
    ...
    function handleClick(e) {
          if ($(this).hasClass('share-facebook')) {
             omniTrackEv('FB Like' + '|' + omni_share_headline);
        } else if ($(this).hasClass('share-twitter') ) {
             omniTrackEv('Twitter'+ '|' + omni_share_headline);
        } 
         else if ($(this).hasClass('share-pinterest') ) {
             omniTrackEv('Pinit'+ '|' + omni_share_headline);
        } 
         else if ($(this).hasClass('share-googleplus') ) {
             omniTrackEv('GooglePlus'+ '|' + omni_share_headline);
        } 
         else if ($(this).hasClass('fave-this-btn') ) {
             omniTrackEv('FAVED'+ '|' + omni_share_headline);
        } 
         else if ($(this).hasClass('unfave-this-btn') ) {
             omniTrackEv('FAVED|Removed'+ '|' + omni_share_headline);
        } 
	...
	function omniTrackEv(omniStr,omniStr2) {
		...
		var aEvent='event43';
		var aList = [['fb-like','event43'],['fb-share','event43'],['google+1','event43'],['twitter','event43'],['faved','event43']]
...
// insert native ads in main nav on hover	
document.domain = 'instyle.com';

function show_native_nav_ad(tabname) {
	$('#native_nav_' + tabname).show();
}

function hide_native_nav_ad() {
	$('.native_nav_ad').hide();
}

//insert fashion native ad call on hover in main nav	
$(document).on({
    mouseenter: function(){
		$('.fashion_native_ad').append('<iframe class="native_nav_ad" id="native_nav_fashion" src="http://www.instyle.com/instyle/static/v4/h/ads/nav_fashion_ad.html" style="display:none;" allowtransparency="true" width="184" height="332" frameborder="0" scrolling="no"></iframe>');	
    },
    mouseleave: function(){
       	$('.fashion_native_ad').empty();	

    }
}, '.nav-fashion');

//insert celebrity native ad call on hover in main nav	
$(document).on({
    mouseenter: function(){
		$('.celebrity_native_ad').append('<iframe class="native_nav_ad" id="native_nav_celebrity" src="http://www.instyle.com/instyle/static/v4/h/ads/nav_celebrity_ad.html" style="display:none;" allowtransparency="true" width="184" height="332" frameborder="0" scrolling="no"></iframe>');	
    },
    mouseleave: function(){
       	$('.celebrity_native_ad').empty();	

    }
}, '.nav-celebrity');

//insert hair native ad call on hover in main nav	
$(document).on({
    mouseenter: function(){
		$('.hair_native_ad').append('<iframe class="native_nav_ad" id="native_nav_hair" src="http://www.instyle.com/instyle/static/v4/h/ads/nav_hair_ad.html" style="display:none;"  allowtransparency="true" width="184" height="332" frameborder="0" scrolling="no"></iframe>');	
    },
    mouseleave: function(){
       	$('.hair_native_ad').empty();	

    }
}, '.nav-hair');

//insert makeup native ad call on hover in main nav	
$(document).on({
    mouseenter: function(){
		$('.makeup_native_ad').append('<iframe class="native_nav_ad" id="native_nav_makeup" src="http://www.instyle.com/instyle/static/v4/h/ads/nav_makeup_ad.html" style="display:none;"  allowtransparency="true" width="184" height="332" frameborder="0" scrolling="no"></iframe>');	
    },
    mouseleave: function(){
       	$('.makeup_native_ad').empty();	

    }
}, '.nav-makeup');

//================================================//
// BEST BEAUTY BUYS FUNCTIONS                     //
//================================================//

// main drop-down navigation
function bbbNav() {
  //navigation listener
  $('#bbbnav a').click(function() {
      ...
      if (parentClass === 'parent') {
        ...
        return false;
      } else if (parentClass === 'parent expanded') {
...
// 'most popular' category carousel 
function bbbCarousel() {
  var busy = false;
  var slidewidth = 160; // includes margin
  //carousel listeners
  $('#bbbcarouselprevious').click(function() {
      if (!busy) {
          busy = true;
  ...
  $('#bbbcarouselnext').click(function() {
      if (!busy) {
          busy = true;
...
// email sub pop-up form
function bbbPopup() {
  // show pop-up and give cookie
  $('li.parent a').click(function() {
    if (!docCookies.hasItem('bbb_email_subbed')) {
      docCookies.setItem('bbb_email_subbed', location.href, 0, '/', '.instyle.com');
      $('.modal').fadeToggle();
    }
  });
  // custom checkbox image replacement
  $('.ez-checkbox').on('click',function(){
      $(this).toggleClass('ez-checked').find('input').attr('checked', !($(this).is('checked')));
  });
  // close email signup window
  $('.popup-close').click(function() {
      $('.modal').fadeToggle();
  });
  // close email thank you window
  $('.back-link').click(function() {
      $('.modal-thankyou').fadeToggle();
  });
}

// email sub pop-up form transition
function showThankyou() {
  $('.modal, .modal-thankyou').fadeToggle();
}

// find products dropdown menu
function bbbFindProducts() {
  //input listeners
  $('#findproducts input').click(function() {
      if ($('#' + $(this).attr('id') + '-list').css('display') == 'none') {
          $('#' + $(this).attr('id') + '-list').slideDown(200);
      } else {
          $('#' + $(this).attr('id') + '-list').slideUp(200);
      }
  });
  //drop down listener
  $('#findproducts div.list a').click(function() {
      var list = $(this).parent().attr('id').split('-');
      $('#' + list[0]).val($(this).text());
      $('#' + list[0] + '-list').slideUp(200);
      return false;
  });
  //"Go" button listeners
  $('#findproductsrow1 input.gobutton').click(function() {
      if ($('#hairtype').val() == 'Normal') {
          document.location = '/instyle/best-beauty-buys/product/0,,20358511,00.html?hairtype=Normal';
      } else if ($('#hairtype').val() == 'Curly/Coarse') {
          document.location = '/instyle/best-beauty-buys/product/0,,20358512,00.html?hairtype=Curly/Coarse';
      } else if ($('#hairtype').val() == 'Fine/Limp') {
          document.location = '/instyle/best-beauty-buys/product/0,,20358513,00.html?hairtype=Fine/Limp';
      } else if ($('#hairtype').val() == 'Color-Treated') {
          document.location = '/instyle/best-beauty-buys/product/0,,20358514,00.html?hairtype=Color-Treated';
      }
      return false;
  });
  $('#findproductsrow2 input.gobutton').click(function() {
      if ($('#skintype').val() == 'Normal') {
          document.location = '/instyle/best-beauty-buys/product/0,,20358496,00.html?skintype=Normal';
      } else if ($('#skintype').val() == 'Dry') {
          document.location = '/instyle/best-beauty-buys/product/0,,20358497,00.html?skintype=Dry';
      } else if ($('#skintype').val() == 'Acne-Prone') {
          document.location = '/instyle/best-beauty-buys/product/0,,20358498,00.html?skintype=Acne-Prone';
      } else if ($('#skintype').val() == 'Sensitive') {
          document.location = '/instyle/best-beauty-buys/product/0,,20358499,00.html?skintype=Sensitive';
      }
      return false;
  });
  $('#findproductsrow3 input.gobutton').click(function() {
      if ($('#skintone').val() == 'Fair') {
          document.location = '/instyle/best-beauty-buys/product/0,,20358474,00.html?skintone=Fair';
      } else if ($('#skintone').val() == 'Medium-Fair') {
          document.location = '/instyle/best-beauty-buys/product/0,,20358475,00.html?skintone=Medium-Fair';
      } else if ($('#skintone').val() == 'Medium-Dark') {
          document.location = '/instyle/best-beauty-buys/product/0,,20358476,00.html?skintone=Medium-Dark';
      } else if ($('#skintone').val() == 'Dark') {
          document.location = '/instyle/best-beauty-buys/product/0,,20358477,00.html?skintone=Dark';
      }
      return false;
  });
}
...
function bbbPinit() {
  // pinit hover graphic
  $('.graphic-pinit').hover(function(){
      $('.pinit-callout').addClass('calledout');
  }, function(){
      $('.pinit-callout').removeClass('calledout');
  });
  // omniture
  $('#bbbgallerybody .pinit').click(function(){
      var pagename = ( typeof s_time.pageName === 'undefined' ) ? 'NOPAGENAME' : s_time.pageName;
      omninfo = 'Pinit|' + pagename;
      omniTrackEv( omninfo );
  });
...
// TODO: Temp fix for desktop JS navigation
function bbbgallery( data ) {
    return true;
}

$(document).ready(function() {
    if ($('body').hasClass('bbb-desktop')) {
    
        // TODO: Temp fix for loading TypeKit in BBB    
        (function(d) {
            var config = {
            kitId: 'krk6rwk',
            scriptTimeout: 3000
            },
            h=d.documentElement,t=setTimeout(function(){h.className=h.className.replace(/\bwf-loading\b/g,"")+" wf-inactive";},config.scriptTimeout),tk=d.createElement("script"),f=false,s=d.getElementsByTagName("script")[0],a;h.className+=" wf-loading";tk.src='//fonts.timeinc.net/'+config.kitId+'.js';tk.async=true;tk.onload=tk.onreadystatechange=function(){a=this.readyState;if(f||a&&a!="complete"&&a!="loaded")return;f=true;clearTimeout(t);try{Typekit.load(config)}catch(e){}};s.parentNode.insertBefore(tk,s)})(document);
        
        // TODO: Temp fix for BBB Pinterest links
        $('.share-pinterest, .graphic-pinit a').attr('href', function() {
                return this.href.replace('InStyle%27s+Best+Beauty+Buys','instylebbb');
        });
...
//     }
// 
//     // This exists as trackPremium in "main.js" but excludes tracking on homepage
//     function trackPremiumTabs() {
//         var label = 'GPN';
...
//     }
// 
//     function trackRowTop() {
// 
//         var rowTop = $('#row-top');
// 
//         function trackLatestMostShared() {
//             var latestMostShared = $('#latest-most-shared'),
//                 columnLeft = rowTop.find('.column.left'),
//                 topStoryTout = columnLeft.find('.top-story.tout'),
//                 dailyVideoTout = $('.daily-video.tout'),
//                 toggle = $('#latest-most-shared .tab'),
//                 panelLatest = $('#panel-latest'),
//                 latestTout = panelLatest.find('.tout'),
//                 panelMostShared = $('#panel-most-shared'),
//                 mostSharedTout = panelMostShared.find('.tout'),
//                 mostSharedFB = $('#panel-most-shared .fbshare a'),
//                 mostSharedTweet = $('#panel-most-shared .tweet a'),
//                 moreHeadlines = latestMostShared.find('.more a');
// 
//             topStoryTout.find('a').each(function () {
//                 var $this = $(this),
//                     label = 'S1_TH1',
//                     text = getText($this);
// 
...
//             });
// 
//             dailyVideoTout.find('a').each(function () {
//                 var $this = $(this),
//                     label = 'S1_TH1B',
//                     text = getText($this, label);
// 
//                 pushPremiumToutArray(label, text);
// 
//                 $this.bind('click', function(){
...
//                     omniTrackEv('toggle-hp-latest');
//                 } else if ($this.hasClass('most-shared')) {
//                     omniTrackEv('toggle-hp-most-shared');
//                 }
//             });
// 
//             latestTout.each(function (i) {
//                 var $this = $(this),
//                     link = $this.find('a'),
//                     increment = i + 2, // + 2 to account for label for topStoryTout
//                     incrementString = increment.toString(),
//                     label = 'S1_TH' + incrementString;
// 
//                 link.each(function () {
//                     var $that = $(this),
//                         text = getText($that, label);
// 
//                     pushPremiumToutArray(label, text);
// 
...
//             });
// 
//             mostSharedTout.each(function (i) {
//                 var $this = $(this),
//                     link = $this.find('a:not(.fbshare a, .tweet a)'),
//                     increment = i + 1, // label is one indexed
//                     incrementString = increment.toString(),
//                     label = 'S1_MS' + incrementString;
// 
//                 link.each(function () {
//                     var $that = $(this),
//                         text = getText($that, label);
...
//             });
// 
//             mostSharedFB.click(function () {
//                 omniTrackEv('fb-share-hp-lh');
//             });
// 
//             mostSharedTweet.click(function () {
//                 omniTrackEv('twitter-hp-lh');
//             });
// 
//             moreHeadlines.click(function () {
//                 var topHeadlinesLength = latestTout.length,
//                     increment = topHeadlinesLength + 2, // number of latest headlines touts, plus top story, plus one
//                     label = 'S1_TH' + increment,
//                     text = $(this).text();
// 
//                 linkTrack(label, text);
//             });
...
// 
//         /*
//          Track top middle sections
//          - #row-top-primary .middle
//          - #row-top-secondary .middle
//          */
//         function trackMiddle() {
// 
//             var $middletop = $('#row-top-primary .middle .first'),
//                 $middlenext = $('#row-top-primary .middle .next'),
//                 $middlebot = $('#row-top-secondary .middle');
// 
//             // Codes for top middle
//             var codes = {
//                 middletop: 'S1_C1',
//                 middlenext: 'S1_C2',
//                 middlebot: 'S2_C1'
//             };
// 
//             // Store codes on column elements
//             $middletop.data('omniture', codes.middletop);
//             $middlenext.data('omniture', codes.middlenext);
//             $middlebot.data('omniture', codes.middlebot);
// 
//             // Middle top clicks
//             $middletop.find('.tout:not(.tv) a').each(function () {
//                 var $this = $(this),
//                     label = codes.middletop,
//                     text = getText($this, label);
// 
//                 pushPremiumToutArray(label, text);
// 
...
// 
//             // Middle next clicks
//             $middlenext.find('.tout:not(.tv) a').each(function () {
//                 var $this = $(this),
//                     label = codes.middlenext,
//                     text = getText($this, label);
// 
//                 pushPremiumToutArray(label, text);
// 
...
// 
//             // Middle bot clicks
//             $middlebot.find('.tout:not(.tv) a').each(function () {
//                 var $this = $(this),
//                     href = $this.attr('href');
//                 if ( typeof href != 'undefined' && href.match(/subscription/) ) {
//                     linkTrack(codes.middlebot, 'CM Tout');
//                 } else {
//                     var label = codes.middlebot,
//                         text = getText($this, label);
// 
//                     pushPremiumToutArray(label, text);
// 
...
//                             // Love it or leave it poll
//                             omniTrackEv('love-it-hp');
//                         } else if($this.hasClass('leave-it')) {
//                             // Love it or leave it poll
//                             omniTrackEv('leave-it-hp');
//                         }
//                         trackWithCookie(label, text);
//                     });
//                 }
//             });
// 
//             // Track PTVPlayer. It's possible it could be in $middlenext or $middlebot.
//             trackPTVPlayer($middlenext);
//             trackPTVPlayer($middlebot);
//         }
// 
//         /*
//          Track top right sections
//          - #row-top-primary .right
//          - #row-top-secondary .right
//          */
//         function trackRight() {
// 
//             var $righttop = $('#row-top-primary .right'),
//                 $rightbot = $('#row-top-secondary .right');
// 
...
//             };
// 
//             var $feelTout = $('#feel-right-now'),
//                 $circulationLink = $('#circulation .tout a');
// 
//             // It's possible #feel-right-now will be replaced by a brightcove player
//             if($feelTout.length) {
//                 var $feelTweet = $feelTout.find('.tweet a'),
//                     $feelFB = $feelTout.find('.fb-share a'),
//                     $moreFeeling = $('.more.feeling a'),
//                     $moreList = $feelTout.find('.feel-list a');
//                 $feelTout.find('.tout a').each(function () {
//                     var $this = $(this),
//                         label = codes.righttop,
//                         text = getText($this, label);
// 
//                     pushPremiumToutArray(label, text);
// 
...
//                     });
//                 });
//                 $moreFeeling.click(function () {
//                     linkTrack(codes.righttop, 'More Stories');
//                 });
//                 $feelTweet.click(function () {
//                     omniTrackEv('twitter-hp-rr');
//                 });
//                 $feelFB.click(function () {
//                     omniTrackEv('fbshare-hp-rr');
//                 });
//                 $moreList.click(function() {
//                     var text = $(this).text();
//                     trackWithCookie(codes.righttop, text);
//                 });
//             }
// 
...
//                         if (domId === 'fb-like-hp-rr') {
//                             omniTrackEv('fb-like-hp-rr');
//                         }
//                     }
//                 );
//             }
// 
//             // Right bottom tout
//             $rightbot.find('.tout a').each(function () {
//                 var $this = $(this),
//                     label = codes.rightbot,
//                     text = getText($this, label);
// 
//                 pushPremiumToutArray(label, text);
// 
...
// 
//             // Circulation link
//             $circulationLink.click(function () {
//                 linkTrack('S1_RR1', 'CM Tout');
//             });
// 
//             // Track PTVPlayer. It's possible it could be in $rightbot
//             trackPTVPlayer($rightbot)
// 
//         }
// 
//         trackLatestMostShared();
//         trackMiddle();
//         trackRight();
// 
//     }
// 
//     /* Note: there is no #omniture-section-1 currently. Instead it is referred to as #rowTop */
//     function trackOmnitureSection2() {
// 
//         // TODO: Should add a class to $section (like .omniture-section-2) & change the selector
//         var $section = $('.row.thirds:first'),
//             $left = $section.find('.column.left'),
//             $middle = $section.find('.column.middle'),
//             $right = $section.find('.column.right');
// 
//         // Codes for this section
//         var codes = {
//             left: 'S2_LR2',
...
// 
//         // Store codes on column elements
//         $left.data('omniture', codes.left);
//         $middle.data('omniture', codes.middle);
//         $right.data('omniture', codes.right);
// 
//         // Tracking on all tout links in section, excluding TV
//         $section
//             .find('.tout:not(.tv)')
//             .find('a').each(function(e) {
//                 var $this = $(this),
//                     code = getOmnitureCodeForSection($this);
// 
//                 if(code) {
//                     var label = code,
//                         text = getText($this, label);
...
//             });
// 
//         // Track PTVPlayer. It's possible it could be in this row
//         trackPTVPlayer($section)
// 
//     }
// 
//     function trackOmnitureSection3() {
// 
//         var $section = $('#partial-must-see'),
//             $left = $section.find('.column.left'),
//             $middle = $section.find('.column.middle'),
//             $right = $section.find('.column.right');
// 
...
//     }
// 
//     function trackRowMustDo() {
// 
//         var getTheLook = $('#get-the-look'),
//             pollModule = $('#row-must-do .poll-module'),
//             standardTout = $('#row-must-do #standard-tout');
// 
//         function trackGetTheLook() {
//             var tout = getTheLook.find('.tout'),
//                 toutLink = tout.find('a:not(.shopcolumn a)');
// 
//             toutLink.live('click', function () {
//                 var label = 'S3_LR1',
//                     text = getText( $(this), label );
// 
//                 linkTrack(label, text);
...
//         }
// 
//         function trackPollModule() {
//             var vote = pollModule.find('.voteBtn'),
//                 related = pollModule.find('.related a');
// 
//             vote.live('click', function () {
//                 omniTrackEv('poll-hp');
//             });
// 
//             related.live('click', function () {
//                 var label = 'S3_RR1',
//                     text = $(this).text();
// 
//                 linkTrack(label, text);
...
//         }
// 
//         function trackStandardTout() {
//             var links = standardTout.find('a:not(h3 a)'),
//                 channel = standardTout.find('h3 a'),
//                 label = 'S3_LR_Recirc';
// 
...
//         }
// 
//         if (getTheLook.length != 0) {
//             trackGetTheLook();
//         }
//         if (pollModule.length != 0) {
//             trackPollModule();
//         }
//         if (standardTout.length != 0) {
//             trackStandardTout();
//         }
//         // tracking for twitter module is handled in twitter.js
//     }
// 
//     function trackRowMostRead() {
//         var toutLink = $('#panel-most-read .tout a'),
//             labelPrefix = 'S3_F';
//         toutLink.each(function () {
//             var $this = $(this),
//                 index = $this.parents('.tout').index(),
//                 labelSuffix = index, // label suffix is one indexed, but there is an element in the dom at index 0
...
// 
//     // noop
//     function trackRowPopularLinks() {
// 
//     }
// 
//     function trackRowTellUs() {
//         var link = $('#row-tell-us a');
...
//     }
// 
//     function trackRowMissedIt() {
//         var threeTouts = $('.row-missed-it.three-touts'),
//             headlinesTouts = $('.row-missed-it.two-touts-headlines'),
//             multiPurpose = $('#row-multi-purpose');
// 
//         function trackThreeTouts() {
//             var toutLink = threeTouts.find('.tout a:not(.more.large a)'),
//                 moreLink = threeTouts.find('.tout .more.large a'),
//                 labelPrefix = 'S4A_';
// 
//             toutLink.each(function () {
//                 var $this = $(this),
...
//                     labelSuffix = 'LR';
//                 } else if (column.hasClass('middle')) {
//                     labelSuffix = 'C';
//                 } else if (column.hasClass('right')) {
//                     labelSuffix = 'RR';
//                 } else {
//                     labelSuffix = 'labelSuffix_unknown';
//                 }
// 
//                 label = labelPrefix + labelSuffix;
// 
...
//         }
// 
//         function trackHeadlinesTouts() {
//             var toutLink = headlinesTouts.find('.tout a:not(.more.large a)'),
//                 moreLink = headlinesTouts.find('.tout .more.large a'),
//                 labelPrefix = 'S4C_';
// 
//             toutLink.each(function () {
//                 var $this = $(this),
//                     text,
//                     column = $this.parents('.column'),
//                     tout = $this.parents('.tout'),
//                     labelSuffix,
//                     label;
// 
//                 if (column.hasClass('left')) {
//                     var index = tout.index(),
//                         increment = index; // label suffix is one indexed, but there is an element in the dom at index 0
// 
//                     labelSuffix = 'LR' + increment;
//                 } else if (column.hasClass('middle')) {
//                     labelSuffix = 'C';
//                 } else if (column.hasClass('right')) {
//                     labelSuffix = 'RR';
...
//         }
// 
//         function trackMultiPurpose() {
//             var toutLink = multiPurpose.find('.tout a'),
//                 moreLink = multiPurpose.find('.more.large a'),
//                 labelPrefix = 'S4B_';
// 
//             toutLink.each(function (e) {
//                 var $this = $(this),
//                     text,
//                     tout = $this.parents('.tout'),
//                     column = $this.parents('.column'),
...
//                 } else if (column.hasClass('right')) {
//                     var index = tout.index(),
//                         increment = index + 1; // label suffix is one indexed
// 
//                     labelSuffix = 'RR' + increment;
//                 } else {
//                     labelSuffix = 'labelSuffix_unknown';
//                 }
// 
...
//         }
// 
//         // these functions may end up being called more than once
//         // due to multiple .missed-it rows being loaded
//         // so we check for $target.data('click') != 'true'
//         if (threeTouts.length != 0) {
//             trackThreeTouts();
//         }
//         if (headlinesTouts.length != 0) {
//             trackHeadlinesTouts();
//         }
//         if (multiPurpose.length != 0) {
//             trackMultiPurpose();
//         }
//     }
// 
//     function trackRowUGC() { // user generated Content
//         function trackCelebBlogger() {
//             var celebLink = $('#celeb-bloggers .tout a');
// 
//             celebLink.each(function () {
//                 var $this = $(this),
//                     text,
//                     index = $this.parents('.tout').index(),
//                     labelPrefix = 'S5_LR',
...
//         }
// 
//         function trackYourTurn() {
//             var uploadLink = $('#your-turn-carousel a'),
//                 popularTopicsLink = $('#popular-topics .tout a');
// 
//             uploadLink.live('click', function () {
//                 linkTrack('S5_YT', 'Upload');
//             });
// 
//             popularTopicsLink.each(function () {
//                 var $this = $(this),
//                     text,
//                     rank = $this.parents('.tout').find('.rank'),
//                     labelPrefix = 'S5_YT',
//                     labelSuffix,
//                     label;
// 
//                 if (rank.length != 0) {
//                     labelSuffix = rank.text();
//                 } else {
//                     labelSuffix = '4';
//                 }
// 
...
//         }
// 
//         function trackLowerRight() {
//             var bottomRightLink = $('#row-user-generated .right .bottom .column .tout a');
// 
//             bottomRightLink.each(function () {
//                 var $this = $(this),
//                     text,
//                     index = $this.parents('.bottom .column').index(),
//                     labelPrefix = 'S5_RR',
//                     labelSuffix = index + 1, // label suffix is one indexed
//                     label = labelPrefix + labelSuffix;
// 
//                 text = getText($this, label);
// 
...
//                 if (event.target.parentElement.className === 'tweet-small') {
//                     omniTrackEv('twitter-hp-hashtag');
//                 }
//             });
//         }
// 
...
//     }
// 
//     /* Tries to retrieve an omniture code stored in $column.data('omniture') */
//     function getOmnitureCodeForSection($el) {
//         if(!$el.length) return;
//         var $column = $el.parents('div.column');
//         return $column.data('omniture');
//     }
// 
//     /* Tries to extract text to send with the omniture code */
//     function getText(el, label) {
//         var parent = el.parents('.tout:not(.tout-multi)'),
//             parentHeadline = el.parents('p.headline'),
//             parentHeadlineFeatured = el.parents('.headline-featured'),
//             h4 = parent.find('h4 a'),
//             headline = parent.find('p.headline a'),
//             text;
// 
//         var premiumClass = 'premium-link',
...
//             text = headline.text();
//         } else if (parentHeadline.length != 0) {
//             text = parentHeadline.text();
//         } else {
//             text = 'Tout Title Unknown';
//         }
// 
//         if (typeof label != 'undefined' && label.match(/CM/)) {
//             text = 'CM Tout';
//         }
// 
//         // Try to figure out if this is premium content.
//         if (el.hasClass(premiumClass)) {
//             // premium-link class is on clicked el
//             isPremiumContent = true;
//         } else if ( parentHeadlineFeatured.length ) {
//             // If this is one of the malformed touts in the #partial-must-see row.
//             if ( parentHeadlineFeatured.find('.' + premiumClass).length ) {
//                 isPremiumContent = true;
//             }
//         } else if ( parent.find('.' + premiumClass).length ) {
//             // Assume whole tout is premium (if it is not one of the malformed multi touts in the #partial-must-see row.
//             isPremiumContent = true;
//         }
// 
//         // Add Premium prefix to text.
//         if (isPremiumContent) {
//             text = 'Premium: ' + text;
//         }
// 
//         // Figure out if this is video content.
//         if ( parent.hasClass('video-tout') || parent.hasClass('tv') ) {
//             isVideoContent = true;
//         }
// 
//         // Add Video prefix to text.
//         if (isVideoContent) {
//             text = 'Video: ' + text;
//         }
// 
...
//         if ( text.match('Premium:') ) {
//             var item = label + ' | ' + text;
//             if ( premiumToutArray.indexOf(item) == -1 ) {
//                 premiumToutArray.push(item);
//             }
//         }
//     }
// 
...
//     }
// 
//     /* The PTV player needs special click handling and won't work with trackTout() */
//     function trackPTVPlayer($section) {
//         $section
//             .find('.tout.tv')
//             .delegate('#arrow,#ptvtitle,#ptvdescription,a', 'click', function(e) {
//                 var $clicked = $(this),
//                     code = getOmnitureCodeForSection($clicked);
//                 if(code) {
//                     var id = $clicked.attr('id');
//                     if(id == 'arrow' || id == 'ptvtitle' || id == 'ptvdecription' ) {
//                         var text = $('#ptvtitle').text();
//                         linkTrack(code, text);
//                     } else {
//                         trackTout($clicked, code);
//                     }
//                 }
//             });
//     }
...
//         trackPremiumTabs();
//         trackRowTop();
//         trackOmnitureSection2();
//         trackOmnitureSection3();
//         trackRowMustDo();
//         trackRowPopularLinks(); // noop
//         trackRowTellUs();
//         trackRowMissedIt();
//         trackRowMostRead();
//         trackRowUGC();
