...
if(typeof page_events!="undefined")s_time.events+=","+page_events;
...
/* Day of week, time of day, wkday-wkend 2012-04-24 */
...
/* gallery name */
if(s_time.prop15 == 'galleries' && location.href.indexOf('package') >-1 && s_time.prop39!='string' && s_time.prop39!='') {
if(/(^(.*)(package)\|(.*)\|(.*)\|(.*)$)/.test(s_time.pageName)) {if(typeof(RegExp.$4)=='string'){s_time.prop39 = RegExp.$4}}
else if(/(^(.*)\|(.*)\|(.*)\|(.*)$)/.test(s_time.pageName)) {if(typeof(RegExp.$3)=='string'){s_time.prop39 = RegExp.$3}}
}
...
/* Visit Number Plugin 2008-07-25 */
...
/* LTV  Block - do not modify 2007-09-26 */
...
/* Hollywood Makeover Tool 2007-10-23 */
...
/* Hollywood Makeover Tool: updated 2014-02-05 */
...
function HHMakeover_tracker(omniStr,omniAccount){
	...
	if(omniType == 'View'){
		...
		s_time.linkTrackVars   = 'prop4,prop14,eVar43,events'; 
		s_time.linkTrackEvents = s_time.events = 'event43';
	 	s_time.tl(this,'o','Makeover Action');
		s_time.linkTrackVars = s_time.linkTrackEvents = 'None';
		s_time.prop4 = s_time.prop14 = s_time.eVar43 = s_time.events = '';
	}
}
/* Hollywood Makeover Taaz Build 2008-06-25 */
...
/* Makeup Match Application: 2008-05-20 */
...
/* Designer Central Flash app and Style Profile Flash app: 2008-12-01 */
