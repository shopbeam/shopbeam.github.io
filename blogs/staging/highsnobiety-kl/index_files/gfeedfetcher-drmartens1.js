...
var gfeedfetcher_loading_image="http://cdn.complexmedianetwork.com/cdn/agenda.complex.com/assets/icons/loading.gif" //Full URL to "loading" image. No need to config after this line!!
...
gfeedfetcher.prototype._displayresult=function(feeds){
	...
	for (var i=0; i<feeds.length; i++){
		...
		var itemdescription=/description/i.test(this.showoptions)? "<br /><a href=\"" + feeds[i].link + "\" target=\"" + this.linktarget + "\" class=\"desc\">" +feeds[i].content : /snippet/i.test(this.showoptions)? "</a><br />"+feeds[i].contentSnippet  : ""
