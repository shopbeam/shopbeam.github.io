...
/* UPDATED Mar 4, 2014  Charlotte Harney */
...
function s_doPlugins(s) {
	...
	s.prop57=s.eVar57=s.getPreviousValue(s.pageName,'gpv_pn');
    s.prop63=s.getPreviousValue(s.prop3,'gpv_ct');
	s.prop58=s.eVar58=s.getDaysSinceLastVisit('s_lv');
	...
	if(s.prop56) {s.eVar56=s.prop56;  }
	if(s.prop59) {s.eVar59=s.prop59;  }
 	if(s.prop63) {s.eVar63=s.prop63;  }
	...
	s.eVar54=s.getVisitNum(365); 
        s.eVar55=s.getVisitNum('w','s_vnum','s_invisit');
        s.eVar51=s.getVisitNum('m','s_vmonthnum','s_monthinvisit');
        s.eVar53=s.getVisitNum('d');
