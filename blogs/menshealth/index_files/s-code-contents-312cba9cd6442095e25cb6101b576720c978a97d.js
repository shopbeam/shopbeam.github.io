...
var s_account="";
if(location.href.indexOf('keycode=')>-1)
{
s_account="rdl.mhwebprod,rdl.oaewebstaging";
}
else{
//catch all
s_account="rdl.mhwebprod";
};
...
s.linkInternalFilters="javascript:,menshealth.com,forums.menshealth.com,traffic.outbrain.com,rodale.com,rodalevillagegreen.com"
...
var getPageNameUrl = function(){
	var pathName = window.location.pathname,
		urlArray = pathName.substring(1,pathName.length).split('/'),
		pageName;
		domain = 'MH';
...
/* Internal Campaign Tracking Config */
if(!s.eVar7)
	s.eVar7=s.getQueryParam('icid');
if(!s.eVar7)
  s.eVar7=s.getQueryParam('cm_sp');  
...
if(!s.eVar75)
	s.eVar75=s.getQueryParam('wcid');


/* Automate Campaign Tracking Code Extraction based on the cm_mmc and cid parameters*/

if(!s.campaign) 
  s.campaign=s.getQueryParam('cid'); 
if(!s.campaign) 
  s.campaign=s.getQueryParam('adbid'); 
if(!s.campaign) 
...
if(!s.prop20)
s.prop20=s.getQueryParam('cm_mmc');

if(!s.prop20)
s.prop20=s.getQueryParam('utm_source'); 
if(!s.prop20)
s.prop20=s.getQueryParam('adbid');
...
/* getVisitNumMonthly */
s.prop4=s.getVisitNum();
  
/* getVisitNumAnnual */
s.prop6=s.getVisitNum(365);
  
/* crossVisitParticipation */
s.eVar2=s.crossVisitParticipation(s.campaign,'s_ev2','30','5','>','purchase',1);
  
/*getTimeParting*/
s.eVar14=s.getTimeParting('h','-5');
s.prop14=s.getTimeParting('h','-5');
  
s.eVar15=s.getTimeParting('d','-5');
s.prop15=s.getTimeParting('d','-5');
s.eVar17=s.getTimeParting('w','-5');
s.prop17=s.getTimeParting('w','-5');
  
/*getNewRepeat*/
s.eVar19=s.getNewRepeat(90,'s_gnr');
s.prop19=s.getNewRepeat(90,'s_gnr');

/*getDaysSInceLastVisit*/
s.eVar18=s.getDaysSinceLastVisit('s_lv');
...
s.eVar5=document.URL

s.eVar10=document.referrer
s.eVar10=s.getValOnce(s.eVar10,'s_ev10');
...
s.visitorNamespace="rodale"
s.trackingServer="rodale.d1.sc.omtrdc.net"
