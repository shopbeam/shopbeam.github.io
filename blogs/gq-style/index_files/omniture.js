...
CN.stats.omniture = (function($) {
    ...
    /**
     * Queues tracking calls until setReady() is called
     * @memberOf CN.stats.omniture
     * @private
     * @type object
     */
    var queue = {
        ...
        flush: function () {
            var loopLength = this.items.length;
    ...
    var s_account = "conde-gqcom",
        server = "stats2.gq.com",
        secureServer = "sstats2.gq.com",
        internalFilters = "javascript:,gq.com,advancemags.com,gqrules.com",
        httpStatus = 200;
